...
<head>
    ...
    <!-- build:css ../resources/chat/chat-min.css -->
    <link href="/monk-dev/resources/common/bootstrap-modal/css/modal-hold.css" rel="stylesheet" type="text/css"/>
...
<!-- build:js ../resources/jquery.min.js -->
...
<!-- endbuild -->
<!-- build:js ../resources/chat/chat-iframe.js -->
<script src="/monk-dev/resources/js/chat/chat-iframe.js" type="text/javascript"></script>
<!-- endbuild -->
