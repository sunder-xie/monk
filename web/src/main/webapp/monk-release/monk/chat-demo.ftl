...
<html>
<head>
    <link href="/monk-release/resources/common/icon/simple-line-icons.min.css" rel="stylesheet" type="text/css">
    <link href="/monk-release/resources/common/chat-demo.css" rel="stylesheet" type="text/css">
</head>
